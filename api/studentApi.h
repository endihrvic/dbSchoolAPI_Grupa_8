...
public:
	...
	/*
	 *Metod treba da u file "db/studenti.txt" snimi studenta sa novim ID brojem.
	...
	/*
	 *Metod treba da u file "db/studenti.txt" snimi studenta sa novim IDom.
	...
	/*
	 *Metod treba da procita studenta iz liste "db/student.txt" sa datim ID brojem.
	 *Ukoliko ID ne postoji u listi, generirati gresku.
	 */
	void del(int id);
	/*
	 *Metod treba da obrise studenta iz liste "db/student.txt" sa datim ID brojem.
	 *Ukoliko ID ne postoji u listi, generirati gresku.
	 */
	void update(int id, std::string, std::string, std::string, std::string, std::string, std::string, int departmentId);
	/*
	 *Metod treba da u fileu "db/studenti.txt" updateuje studenta sa vec postojecim ID brojem.
	...
	/*
	 *Metod treba da u fileu "db/studenti.txt" updateuje studenta sa novim IDom.
